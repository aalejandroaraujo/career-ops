...
const REPO = "https://github.com/aalejandroaraujo/career-ops.git";
const LATEST_RELEASE = "https://api.github.com/repos/aalejandroaraujo/career-ops/releases/latest";
...
Docs: https://github.com/aalejandroaraujo/career-ops`;
